...
{
    DML_LINK_TYPE_Eth       = 1,
    DML_LINK_TYPE_EthLink,
    DML_LINK_TYPE_EthVlan,
    DML_LINK_TYPE_Usb,
    DML_LINK_TYPE_Hpna,
    DML_LINK_TYPE_Moca,
    DML_LINK_TYPE_HomePlug,
    DML_LINK_TYPE_Upa,
    DML_LINK_TYPE_WiFiSsid,
    DML_LINK_TYPE_Bridge,
    DML_LINK_TYPE_PPP,
    DML_LINK_TYPE_DOCSIS,
    DML_LINK_TYPE_LAST
}
DML_LINK_TYPE, *PDML_LINK_TYPE;

#define DML_LINK_TYPE_TOTAL                    DML_LINK_TYPE_LAST
...
char*               CosaUtilGetLinkTypePath(DML_LINK_TYPE LinkType);
char*               CosaUtilGetStrFromLinkTypePath(char* pLinkTypePath);
char*               CosaUtilGetLinkTypeStr(DML_LINK_TYPE LinkType);
DML_LINK_TYPE  CosaUtilGetLinkTypeFromStr(char* pLinkTypeStr);
DML_LINK_TYPE  CosaUtilGetLinkTypeFromPath(char*pLinkTypePath);
